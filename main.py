import argparse
from utils import init_dir, set_seed, get_num_rel, get_num_ent
...
if __name__ == '__main__':
    ...
    parser.add_argument('--metatrain_state', default='./sggtate/fb237_v1_transe/fb237_v1_transe.best', type=str)

    parser.add_argument('--state_dir', '-state_dir', default='./sggtate', type=str)
    ...
    parser.add_argument('--metatrain_num_neg', default=1)
    parser.add_argument('--metatrain_num_pos', default=1)
    parser.add_argument('--metatrain_num_epoch', default=20)
    parser.add_argument('--metatrain_bs', default=32, type=int)
    parser.add_argument('--metatrain_lr', default=0.01, type=float)
    parser.add_argument('--metatrain_check_per_step', default=100, type=int)
    parser.add_argument('--indtest_eval_bs', default=128, type=int)

    # params for fine-tune
    parser.add_argument('--posttrain_num_neg', default=1, type=int)
    parser.add_argument('--posttrain_bs', default=32, type=int)
